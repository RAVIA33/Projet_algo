...
class EtreVivantSprite(pygame.sprite.Sprite) :
    ...
    def __init__(self, surface : pygame.Surface, etreVivant : EtreVivant, type_name : str,  color_name : str, *groups : List[pygame.sprite.Group]) -> None :
        pygame.sprite.Sprite.__init__(self, *groups)
        self._surface = surface
        self._etreVivant =  EtreVivant
