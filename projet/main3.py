...
class App:
    ...
    def __init_actors(self) -> None:
        ...
        ActorSprite(self.__screen, player, "white", [self.__player_sprite])
        self.__actors_sprites = pygame.sprite.Group()
        ActorSprite(self.__screen, actor_00, "blue", [self.__actors_sprites])
        ActorSprite(self.__screen, actor_01, "red", [self.__actors_sprites])
