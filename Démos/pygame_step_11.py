...
class ActorSpriteDrivenByMouse(ActorSprite):
    ...
    def update(self):
        if pygame.mouse.get_focused(): #position souris
...
class App:
    ...
    def __init_actors(self) -> None:
        ...
        actor_02 : Actor = Actor(pygame.Vector2(150, 150), pygame.Vector2(0, 150), (80, 100))
        ...
        ActorSpriteDrivenByRandom(actor_02, "purple", [self.__actors_sprites])
